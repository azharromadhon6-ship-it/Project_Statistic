...
const TOOL_GUIDES = {
  ...
  runchart: {
    ...
    fields: [
      ...
      { name: 'Median',
        desc: 'Garis horizontal amber putus-putus yang menunjukkan nilai tengah seluruh data. Selalu tampil otomatis. Titik biru = di atas median, ungu = di bawah median.' },
      { name: 'Jumlah Run',
        desc: 'Banyaknya kelompok titik berurutan yang berada di satu sisi median. Terlalu sedikit atau terlalu banyak run mengindikasikan pola non-random.' },
      { name: 'Anotasi',
